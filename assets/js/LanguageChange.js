const i18Obj = {
  en: {
    sliderText1: "Lorem Ipsum is simply dummy text 1",
    sliderText2: "Lorem Ipsum is simply dummy text 2",
    sliderText3: "Lorem Ipsum is simply dummy text 3",
    ...
    DeliveryFAQText: "Where can i found your company?",
    DeliveryFAQMainText: "Learn about ours office location on map",
    PaymentType: "What payment methods can you offer?",
    PaymentMainType: "Choose the most convenient payment option for you",
    LocationText: "Hey, look at this!",
    OrderButton: "Oreder Now",
    ReviewsButton: "Reviews",
    ReviewsModal: "Shelf life? What guarantees do we have? I'll tell you now!",
    ReviewsText: "Our honnor...",
    description1: "A chic store, I'll decorate the whole house with flowers! I advise everyone!",
    Name1: "Anna Gray",
    description2: "It's just a wonderful miracle, the store is just a cannon! Everyone get the flowers!",
    Name2: "Sonya Sonkinz",
    followingLink: "Subscribe! You won't get bored with us...",
    ReviewMainText: "Our store delivers the highest quality goods! The plucked flowers are stored in the warehouse for 5 days, and then they are thrown away. All plants are stored in a special refrigerator, with ideal conditions for them, so in the end you will get the best product",
    ReviewMainText2: "However, even if this is not enough for you... You can go to the reviews section and personally verify the quality of our plants!",
  },
  ru: {
    sliderText1: "Lorem Ipsum — это просто текст-пустышка 1",
    sliderText2: "Lorem Ipsum - это просто текст-заполнитель 2",
    sliderText3: "Lorem Ipsum - это просто текст-заполнитель 3",
    ...
    DeliveryFAQText: "А где я смогу найти ваш офис?",
    DeliveryFAQMainText: "Узнайте где находиться наш офис",
    PaymentType: "Какие способы оплаты вы можете преложить?",
    PaymentMainType: "Выберете удобный способ оплаты для вас",
    LocationText: "Эй, мы тут, нас легко найти!",
    OrderButton: "Купить сейчас",
    ReviewsButton: "Отзывы",
    ReviewsModal: "Сроки хранения? Какие у нас гарантии? Сейчас расскажу!",
    ReviewsText: "Наша гордость...",
    description1: "Шикарный магазин, обаставлю весь дом цветами! Всем советую!",
    Name1: "Анна Грей",
    description2: "Это просто чуду чудесное, магазин просто пушка! Всем за цветами!",
    Name2: "Соня Сонькинз",
    followingLink: "Подписывайтесь! С нами не заскучаешь...",
    ReviewMainText: "Наш магазин поставляет товар наивысшего качества! Сорванные цветы храняться на складе 5 дней, а дальше выбрасываются. Все растения храняться в специальном холодильнике, с идеальными для них условиями, поэтому в итоге вы получите наилучший товар",
    ReviewMainText2: "Однако, даже если этого вам мало... Вы можете перейти в раздел отзывы и лично убедиться в качестве наших растений!",
  }
};
